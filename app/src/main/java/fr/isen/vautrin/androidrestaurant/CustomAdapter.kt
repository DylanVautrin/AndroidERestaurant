...
class CustomAdapter(private var mList: List<Item>,val mListener: (Item) -> Unit) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Picasso.get().load(url).error(R.drawable.noimg).into(holder.imageView)
